...
For a regulated example of what those permissions and limits look like in practice, see [Building HIPAA-compliant AI agents](https://eldur.studio/resources/building-hipaa-compliant-ai-agents/).
